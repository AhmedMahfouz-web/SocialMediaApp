    ...
    <section>
        <section class="create-post">
            ...
            <article class="aria">
                ...
                <textarea placeholder="شارك افكارك وتجاربك مع من هم حولك." name="" id="writingArea"></textarea>
                <footer>
                    <article class="color-plate">
                        ...
                        <button class="color-btn" style="background-color: aquamarine"></button>
                        ...
                        <button class="color-btn" style="background-color: rgb(15, 153, 153)"></button>
                        <button class="color-btn" style="background-color: blueviolet"></button>
                        <button class="color-btn" style="background-color: green"></button>
                        <button class="color-btn" style="background-color: rgb(51, 49, 25)"></button>
                    </article>
